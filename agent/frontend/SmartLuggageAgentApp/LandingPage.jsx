...
function LogoIcon({ className = 'h-8 w-8' }) {
  return (
    <svg viewBox="0 0 32 32" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect width="32" height="32" rx="8" fill="#ff4b33" />
...
function SmartSuitcase() {
  return (
    <svg viewBox="0 0 200 220" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: '100%' }}>
      {/* Drop shadow */}
      <ellipse cx="100" cy="210" rx="55" ry="8" fill="#ff4b33" opacity="0.12" />
      ...
      {/* Latches */}
      <rect x="84" y="90" width="32" height="16" rx="4" fill="#ff4b33" />
      <rect x="84" y="118" width="32" height="16" rx="4" fill="#ff4b33" />
      ...
      {/* Luggage tag */}
      <rect x="148" y="72" width="22" height="32" rx="4" fill="#ff4b33" />
      <circle cx="159" cy="68" r="4" fill="none" stroke="#ff4b33" strokeWidth="2" />
  ...
  return (
    <motion.div
      style={{
        ...
        right: '12.5%',
        height: '3px',
        background: 'linear-gradient(90deg, transparent, #ff4b33, #ff6b55, #ff4b33, transparent)',
        borderRadius: '2px',
...
// --- Orbit dots ---
function OrbitDot({ delay, radius, size = 6, color = '#ff4b33' }) {
  return (
    <motion.div
      style={{
        position: 'absolute',
...
function AnimatedSuitcaseHero() {
  return (
    <div style={{ position: 'relative', width: 280, height: 300, margin: '0 auto' }}>
      ...
      {/* Orbit dots */}
      <OrbitDot delay={0} radius={120} size={7} color="#ff4b33" />
